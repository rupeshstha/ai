...
class SitemapController extends Controller
{
	...
	public function __construct()
	{
		...
		$this->mainStaticRoutes = (!empty(config('sitemap.mainStaticRoutes'))) ? config('sitemap.mainStaticRoutes') : [];
	...
	{
		return response()->view('voyager::sitemap.index', ['data' => $this->pages])->header('Content-Type', 'text/xml');
	}
