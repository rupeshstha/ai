            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ voyager_asset('images/admin-light.svg') }}" alt="Logo Icon">
                        @else
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        ...
                        <div class="controls float-right">
                            <a href="{{ route('voyager.forgot_password.index') }}">Forgot Password?</a>
                        </div>
                    </div>
